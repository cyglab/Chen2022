...
subplot(3,2,2);
load('lmeERPufPE.mat')
baseAIC=lmeERP.AIC(:,53);
clear lmeERP;

load('lmeERPufDkl.mat')
plot(x,lmeERP.AIC(:,53)-baseAIC,'LineWidth',2,'Color',[239 86 117]/255);
hold on;
clear lmeERP;

load('lmeERPufDIs.mat')
plot(x,lmeERP.AIC(:,53)-baseAIC,'LineWidth',2,'Color',[255 166 0]/255);
hold on;
clear lmeERP;
...
fill ([200 200 500 500],[-20 60 60 -20],'k','facealpha',0.1);
...
load('lmeERPcvPC.mat')
plot(x,lmeERP.AIC(:,53)-baseAIC,'LineWidth',2,'Color',[122 81 149]/255);
hold on;
clear lmeERP;
